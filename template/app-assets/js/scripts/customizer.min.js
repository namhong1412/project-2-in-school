! function(e, a, o) { "use strict"; if (o(".customizer-toggle").on("click", function() { o(".customizer").toggleClass("open") }), o(".customizer-close").on("click", function() { o(".customizer").removeClass("open") }), 0 < o(".customizer-content").length) new PerfectScrollbar(".customizer-content", { wheelPropagation: !1 }); var s = o("body"),
